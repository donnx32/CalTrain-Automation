...
public class MainView extends JFrame {
	...
	public void initComponents() {
		...
		cmbBoxStart.setModel(new DefaultComboBoxModel<String>(
				new String[] { "Alpha", "Bravo", "Charlie", "Delta", "Echo", "Foxtrot", "Golf", "Hotel" }));
		...
		cmbBoxDestination.setModel(new DefaultComboBoxModel<String>(
				new String[] { "Alpha", "Bravo", "Charlie", "Delta", "Echo", "Foxtrot", "Golf", "Hotel" }));
		cmbBoxDestination.setBounds(195, 61, 100, 30);
		cmbBoxDestination.setSelectedIndex(1);
	...
	public void generateListeners() {
		...
		btnDeploy.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent evt) {
				...
				if(CalTrainII.trainList.size() != 16) {
					if(cc > -1){
						c.deployTrain(cc);
					...
					JOptionPane.showMessageDialog(null, "cannot deploy more trains");
				}
				txtFldCapacity.setText("Capacity");
